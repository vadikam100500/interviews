# Fabrique(notifications service)
...
К сожелению написать докстринги и комментарии не хватает времени.

## Local Deploy:

+ Set secrets in .env like:
    ```sh
    ...
    CONTACT_EMAIL=agagag@gmail.com
    LICENSE=MIT License
    ...
    DJANGO_SUPERUSER_PHONE=70101234567
    ```
